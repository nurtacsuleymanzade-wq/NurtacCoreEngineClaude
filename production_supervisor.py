...
ENGINES = [
    ...
    # DISABLED_RAM: ("smart_money_engine", ["run_smartmoney", "run_live", "main"]),
    ("evidence_engine", ["run_evidence", "run_live", "main"]),
    # DISABLED_RAM: ("market_context_engine", ["run_context", "run_live", "main"]),
    # DISABLED_RAM: ("volume_profile_engine", ["run_volprofile", "run_live", "main"]),
    # DISABLED_RAM: ("scenario_engine", ["run_scenario", "run_live", "main"]),
